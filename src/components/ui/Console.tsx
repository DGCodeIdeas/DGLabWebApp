...
export default function Console({ logs, title = "System Console", maxHeight = "300px" }: ConsoleProps) {
  ...
  return (
    <div className="bg-gray-950 border border-gray-800 rounded-2xl overflow-hidden shadow-2xl flex flex-col">
      ...
      <div 
        ref={scrollRef}
        className="p-4 font-mono text-[11px] leading-relaxed overflow-y-auto custom-scrollbar"
        style={{ maxHeight }}
      >
          ...
          {logs.length === 0 ? (
            ...
            logs.map((log) => (
              <motion.div 
                ...
                className="flex items-start space-x-2 mb-1 group"
              >
        ...
        <div className="flex items-center space-x-2 mt-1">
          ...
          <ChevronRight size={12} className="text-gray-700 animate-pulse" />
